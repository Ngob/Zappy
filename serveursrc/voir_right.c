/*
** voir_right.c for  in /home/capot_r//tek2/c/zappy/serveursrc
** 
** Made by romain capot
** Login   <capot_r@epitech.net>
** 
** Started on  Sun Jul 10 13:29:56 2011 romain capot
** Last update Sun Jul 10 13:29:56 2011 romain capot
*/
...
void		voir_right(t_data *d, int fd, int pos_y)
{
  char		*res;
  int		i;
  int		vision;
